  ...
  render() {
    return (
      <div className="Apply">
        ...
        <p>만 19세 이상 성인의 경우, 신용등급이 1등급에서 8등급까지 비상금 신청이 가능합니다. (단, 신용등급 범위 내라 하더라도 서울보증보험 보증서 발급이 거절되거나, 연체 등 신용도판단정보, 회생, 파산, 면책 정보 , 금융사기 관련 정보 등 대출 부적격 사유가 있는 경우에는 대출이 불가능합니다.)</p>
